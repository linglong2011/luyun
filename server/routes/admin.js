...
// 删除指定id的栏目
admin.delete("/block/delete/:id", require('../controllers/block/deleteById'));
// 获取指定id的栏目
admin.get("/block/getblock/:id", require('../controllers/block/getById'));
// 修改指定id的栏目
admin.put("/block/editblock/:id", jsonParser, require('../controllers/block/editById'));
